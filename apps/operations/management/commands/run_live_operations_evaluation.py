...
from apps.operations.operations_evaluation import run_operations_evaluation


class Command(BaseCommand):
    help = "Run the synthetic-only OpenAI Operations Loop evaluation suite."
    ...
    def handle(self, *args, **options):
        ...
        evaluation = run_operations_evaluation(
            company=company,
            actor="management-command:live-operations-evaluation",
            live=True,
            model=options["model"],
        )
        self.stdout.write(
